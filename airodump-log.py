...
class Station:
    ...
    def show(self, bssid_to_essid=None):
        return 'STA {0:<18} probes:{1} auth_req:{2}'.format(self.bssid,
                                                            repr(self.probes),
                                                            repr([self._show_bssid(auth_req, bssid_to_essid) for
                                                                  auth_req in self.auth_reqs]))
...
class Dot11Scanner:
    ...
    def print_results(self):
        Printer.write('\n\n')
        Printer.write(
            '{0:<18} {1:>3} {2:5} {3:5} {4:2} {5:<4} {6:<4} {7:<4} {8:<4} {9:3} {10:<32}'.format('BSSID', 'PWR',
                                                                                                 '#BEAC', '#DATA', 'CH',
                                                                                                 'MB', 'ENC', 'CIPH',
                                                                                                 'AUTH', 'HID',
                                                                                                 'ESSID'))
...
class Display:
    def __init__(self, window, scanner):
        ...
        self.window.clear()
        header = '{0:<18} {1:>3} {2:5} {3:5} {4:2} {5:<4} {6:<4} {7:<4} {8:<4} {9:3} {10:<32}'.format('BSSID', 'PWR',
                                                                                                      '#BEAC', '#DATA',
                                                                                                      'CH', 'MB', 'ENC',
                                                                                                      'CIPH', 'AUTH',
                                                                                                      'HID', 'ESSID')
